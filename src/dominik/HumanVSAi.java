		...
		do{		
			...
			if (runde % 2 == 0) {
				if(getSpieler1().getName().equals("Computer")){
					...
					if(aiMove == null) {
						System.out.println("Der Computer hat keinen Zug mehr! Du hast gewonnen!");
						setExit = true;
					} else {
						bewegen(aiMove,runde);
						aiZug=true;
						System.out.println("Der Computer hat seinen Zug gemacht! Er hat den Zug " + aiMove + " ausgeführt.");
					}
				}else{
