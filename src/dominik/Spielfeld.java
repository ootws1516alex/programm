...
public class Spielfeld {
	...
	public void startAufstellung(){
		...
		sSteine.add(this.koords[0][1].getSpielstein());
		sSteine.add(this.koords[0][3].getSpielstein());
		sSteine.add(this.koords[0][5].getSpielstein());
		sSteine.add(this.koords[1][0].getSpielstein());
		sSteine.add(this.koords[1][2].getSpielstein());
		sSteine.add(this.koords[1][4].getSpielstein());
		wSteine.add(this.koords[4][1].getSpielstein());
		wSteine.add(this.koords[4][3].getSpielstein());
		wSteine.add(this.koords[4][5].getSpielstein());
		wSteine.add(this.koords[5][0].getSpielstein());
		wSteine.add(this.koords[5][2].getSpielstein());
		wSteine.add(this.koords[5][4].getSpielstein());
